...
Wget stands for web get and is used to download files from the web directly to the computer. For example wget http://example.com/file.txt will download file.txt straight into the current directory.
