...
if(os.path.exists(deps_dir)):
	...
	call('echo {} | {}'.format(sudoPassword, cmd), shell=True)
	os.system('(cd '+deps_dir+'/build/OpenCV; cmake -DWITH_QT=ON -DWITH_OPENCL=OFF -DWITH_OPENCLAMDFFT=OFF -DWITH_OPENCLAMDBLAS=OFF -DWITH_VA_INTEL=OFF -DWITH_OPENCL_SVM=OFF ../../opencv-3.3.0 )');
